...
function swsCoreStats() {
    ...
    this.promClientMetrics.nodejs_process_cpu_server_usage_percentage = new promClient.Gauge({
        name: swsUtil.swsMetrics.nodejs_process_cpu_server_usage_percentage.name,
        help: swsUtil.swsMetrics.nodejs_process_cpu_server_usage_percentage.help });
}
...
swsCoreStats.prototype.calculateSystemStats = function(ts,totalElapsedSec) {
    ...
    this.sys.cpuServer = swsUtil.swsCPUUsageServer(); 
    this.sys.memorySystem = os.totalmem() - os.freemem(); 
    ...
    this.promClientMetrics.nodejs_process_cpu_server_usage_percentage.set(this.sys.cpuServer);
};
