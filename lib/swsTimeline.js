...
swsTimeline.prototype.tick = function (ts,totalElapsedSec) {
    ...
    var cpuServerPercent = swsUtil.getswsCPUUsageServer(); 
    currBucket.sys.cpuServer = cpuServerPercent;
...
swsTimeline.prototype.openTimelineBucket = function(timelineid) {
    ...
    // Open new bucket
    this.data[timelineid] = { stats: new swsReqResStats(this.options.apdexThreshold), sys: { rss:0, heapTotal:0, heapUsed:0, external:0, cpu: 0, cpuServer: 0} };
...
swsTimeline.prototype.closeTimelineBucket = function(timelineid) {
    ...
    //var cpuServerPercent = swsUtil.swsCPUUsageServer(); 
    //this.data[timelineid].sys.cpuServer = cpuServerPercent;
