...
module.exports.swsMetrics = {
    ...
    nodejs_process_cpu_server_usage_percentage: { name: 'nodejs_process_cpu_server_usage_percentage', type: 'gauge', help: 'System CPU usage percentage'},
...
var stat1 = getCPUInfo();
var percentUsageServer = 0;
module.exports.swsCPUUsageServer = function() {
    var stat2 = getCPUInfo();
    
    var idle    = stat2.idle - stat1.idle;
    var total   = stat2.total - stat1.total;
    var percent = (total / (total + idle)) * 100;

    stat1 = stat2;
    percentUsageServer = percent;
    return percent;
};

module.exports.getswsCPUUsageServer  = function(){ return percentUsageServer; }
